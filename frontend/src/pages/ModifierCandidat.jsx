...
function ModifierCandidat({
  ...
  const [form, setForm] = useState({
    ...
    situation_actuelle: candidat.situation_actuelle || "",
    representant_nom: candidat.representant_nom || "",
    representant_telephone: candidat.representant_telephone || "",
    representant_email: candidat.representant_email || "",
    formation_id: candidat.formation_id || "",

    numero_securite_sociale: candidat.numero_securite_sociale || "",
    permis_b: candidat.permis_b || "",
    vehicule: candidat.vehicule || "",
    demandeur_emploi: candidat.demandeur_emploi || "",
    identifiant_france_travail: candidat.identifiant_france_travail || "",
    indemnites: candidat.indemnites || "",
    etudiant: candidat.etudiant || "",
    derniere_classe: candidat.derniere_classe || "",
    dernier_diplome_obtenu: candidat.dernier_diplome_obtenu || "",
    nom_etablissement: candidat.nom_etablissement || "",
    alternance_deja_faite: candidat.alternance_deja_faite || "",
    entreprise_accueil: candidat.entreprise_accueil || "",
    type_contrat: candidat.type_contrat || "",
    handicap: candidat.handicap || "",
    amenagement_handicap: candidat.amenagement_handicap || "",
    motivations: candidat.motivations || "",
    objectif_formation: candidat.objectif_formation || "",
    competences_souhaitees: candidat.competences_souhaitees || "",
    contraintes: candidat.contraintes || "",
    autres_infos: candidat.autres_infos || "",
    disponibilite_immediate: candidat.disponibilite_immediate || "",
    date_disponibilite: candidat.date_disponibilite || "",

    niveau_word: candidat.niveau_word || "",
    niveau_messagerie: candidat.niveau_messagerie || "",
    niveau_reseaux_sociaux: candidat.niveau_reseaux_sociaux || "",
    niveau_excel: candidat.niveau_excel || "",
    niveau_powerpoint: candidat.niveau_powerpoint || "",
    autres_logiciels: candidat.autres_logiciels || "",
    niveau_autres_logiciels: candidat.niveau_autres_logiciels || "",

    langue_1: candidat.langue_1 || "",
    niveau_langue_1: candidat.niveau_langue_1 || "",
    langue_2: candidat.langue_2 || "",
    niveau_langue_2: candidat.niveau_langue_2 || "",
    langue_3: candidat.langue_3 || "",
    niveau_langue_3: candidat.niveau_langue_3 || "",

    date_entretien: candidat.date_entretien || "",
    conseiller_formation: candidat.conseiller_formation || "",
    test_francais: candidat.test_francais || "",
    test_mathematiques: candidat.test_mathematiques || "",
    test_culture_generale: candidat.test_culture_generale || "",
    appreciation_globale: candidat.appreciation_globale || ""
  });
  ...
  "/historique",
  {
    ...
    body: JSON.stringify({
      ...
      action: "Informations du candidat modifiées"
    })
  }
);
  ...
  `/candidats/${candidat.id}`,
  {
    ...
    body: JSON.stringify(form)
      ...
      if (response.ok) {
        ...
        notifier("Candidat modifié avec succès", "success");
    ...
    <FormContext.Provider value={{ form, changerChamp }}>
      ...
      <div className="inscription-page">
        ...
        <button
          className="back-btn"
          onClick={() => {
            notifier("Modification annulée", "info");
            retour();
          }}
        >
          ← Retour
        ...
        <div className="inscription-header">
          ...
          <div>
            ...
            <p>
              Modification du dossier de {candidat.nom} {candidat.prenom}
            </p>
          </div>
        ...
        <div className="inscription-grid">
          ...
          <section className="inscription-card inscription-summary">
            ...
            <p>
              Vérifie les informations principales avant d'enregistrer les modifications.
            </p>
